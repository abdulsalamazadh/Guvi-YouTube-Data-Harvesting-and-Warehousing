...
def channel_details(Channel_id):
    ...
    return {"Channel_details": channel_detail,
...
def dataframes(youtubeChannelID):
    ...
    Channel_fulldetails = channel_details(youtubeChannelID)
...
#function for collecting all tables
...
#function to insert tables to sql

def insert_tables_to_sql(youtubeChannelID):
